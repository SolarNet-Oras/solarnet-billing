...
export function RouterQosMonitor({ routers }: RouterQosMonitorProps) {
  ...
  const handleSafePreview = async () => {
    if (!selectedRouter || !analysis?.safe.available || !safeCustomerId) return;
    try {
