...
export default function TechnicianDashboardPage() {
  ...
  const captureRegistrationLocation = (): void => {
    if (!navigator.geolocation) {
      setRegistrationLocationMessage('This device cannot provide GPS location. You can continue without coordinates.');
      return;
    }
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      () => {
        setRegistrationLocationMessage('Location permission was not granted or GPS could not be read. You can continue without coordinates.');
        setRegistrationLocationBusy(false);
      },
