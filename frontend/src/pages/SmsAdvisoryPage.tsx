...
type Campaign = { id: string; title: string; message: string; recipient_filter: Filter; status: string; recipient_count: number; sent_count: number; failed_count: number; skipped_count: number; created_at: string; creator?: { name: string } };

const emptyForm = { title: '', message: '', recipient_filter: 'active' as Filter };
