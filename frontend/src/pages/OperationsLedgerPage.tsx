...
export default function OperationsLedgerPage(): React.JSX.Element {
  ...
  const wallets: Array<['cash' | 'gcash' | 'paymongo' | 'bpi' | 'landbank', string, string]> = [['cash', 'Cash', 'text-emerald-600'], ['gcash', 'GCash (direct/manual)', 'text-violet-600'], ['paymongo', 'PayMongo (GCash + QR Ph)', 'text-fuchsia-600'], ['bpi', 'BPI', 'text-blue-600'], ['landbank', 'Landbank', 'text-cyan-600']];
