...
export default function OperationsLedgerPage(): React.JSX.Element {
  ...
  const activeDefinitions = useMemo(() => definitions.filter((definition) => definition.active !== false && (canTopUpCash || !(definition.effect_type === 'cash_in' && !definition.source_wallet && ['cash', 'bpi', 'landbank'].includes(String(definition.destination_wallet))))), [definitions, canTopUpCash]);
