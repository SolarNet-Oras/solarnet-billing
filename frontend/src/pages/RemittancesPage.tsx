...
export default function RemittancesPage() {
  ...
  return <DashboardLayout><main className="space-y-6 p-4 md:p-6">
    ...
    {liquidationTarget && cashExcess && !showExcessDialog && <button type="button" onClick={() => setShowExcessDialog(true)} className="fixed bottom-24 left-1/2 z-[60] -translate-x-1/2 rounded-full border border-blue-300 bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-xl hover:bg-blue-700">Handle cash change</button>}
