...
export default function RemittancesPage() {
  ...
  return <DashboardLayout><main className="space-y-6 p-4 md:p-6">
    ...
    </> : <section className="space-y-3">{remittances.map((item) => {
    ...
    })}{!remittances.length && <section className="rounded-2xl border bg-card p-8 text-center text-muted-foreground">No remittances submitted.</section>}</section>}
